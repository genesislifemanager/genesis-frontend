...
function Root() {
  ...
  if (isLoading) {
    return (
      <div className="container px-4 py-4  items-center flex justify-center border relative border-black">
  ...
  return (
    <div className="container px-4 py-4  border relative border-black">
      <Header />
      <Outlet />
